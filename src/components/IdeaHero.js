    ...
    <div>
        ...
        <div className=" justify-self-center m-auto">
           <div className="m-auto flex flex-col">
             <p className="text-3xl lg:text-5xl text-white m-auto font-bold ">{title}</p>
             <p className="text-xl text-center lg:flex lg:flex-row  p-6 mb-4" style={{color:' #ffffff'}}>{tagline}</p>
