        ...
        <div class=" justify-self-center m-auto">
           <div class="m-auto flex flex-col">
             ...
             <div class="justify-items-center flex flex-row m-auto">
               <a href="/create/idea" class="p-4 mr-4 m-auto hover:shadow-md hover:p-3 text-md  flex flex-row font-bold border-solid shadow-xl rounded-md bg-black text-white"> New Idea</a>
